...
(*               shallow (FForall f) (x:a -> t x) -- lots of warnings *)
               shallow (FForall f) (x:a -> t x)
  | ShEq     : #a:Type ->
               x1:a ->
               x2:a ->
               shallow (FEq x1 x2) (ceq x1 x2)

type valid_shallow (f:form) = (cexists_type (fun (t:Type) -> cand (shallow f t) t))
